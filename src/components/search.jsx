...
function Search(props) {
  ...
  return (
    ...
    >
      <input
        className="w-full md:w-1/2 md:h-10 px-4 py-2 rounded-3xl text-white placeholder-gray-400 bg-dark-home md:bg-dark-mode focus:outline-none focus:bg-dark-second md:focus:bg-dark-mode transition-all ease-in delay-100 focus:bg-opacity-20 md:focus:bg-opacity-75 shadow-xl mb-5 md:mb-0"
        value={location}
