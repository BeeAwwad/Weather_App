...
function BottomPart(props) {
  ...
  return (
    <>
      {data.main ? (
        <div className="flex m-4 justify-between bg-dark-second text-dark-mode p-3 rounded-lg mx-4">
          <div>
            {data.wind ? (
              <div className="flex flex-col mx-3 p-1 items-center">
                <svg className="w-8 h-7 mt-2" viewBox="0 0 24 24">
          ...
          <div>
            {data.main ? (
              <div className="flex flex-col mx-3 p-1 items-center">
                <svg className="w-16 h-12" viewBox="0 0 100 125">
                  <g>
